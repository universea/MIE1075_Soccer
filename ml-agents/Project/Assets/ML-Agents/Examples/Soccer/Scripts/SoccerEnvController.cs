...
public class SoccerEnvController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        print(m_BlueAgentGroup);
        print(m_PurpleAgentGroup);
        ResetScene();
    }
    ...
    public void GoalTouched(Team scoredTeam)
    {
        ...
        {
            m_BlueAgentGroup.AddGroupReward(1.0f - (float)m_ResetTimer / MaxEnvironmentSteps);
            m_PurpleAgentGroup.AddGroupReward(-1.0f);
        }
        else
        {
            m_PurpleAgentGroup.AddGroupReward(1.0f - (float)m_ResetTimer / MaxEnvironmentSteps);
