...
engine_channel.set_configuration_parameters(time_scale=20,quality_level=0)
...
origin_env = UnityEnvironment(file_name="C://Users//raman//Documents//Pengsong//MIE1075_Soccer//osoccer//UnityEnvironment", seed=1, no_graphics=True,side_channels=[engine_channel])
...
CRITIC_LR = 0.003  # learning rate for the critic model
ACTOR_LR = 0.003  # learning rate of the actor model
